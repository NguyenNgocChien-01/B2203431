...
if ($result->num_rows > 0) {
    ...
    echo '<img src="./uploads/' . $row['img_profile'] . '" alt="Ảnh profile" width=190 heigth=100>';
}
...
?>
<br><br>
<button><a href="thoat.php">Đăng xuất</a></button><br>
<button><a href="sua_mk.php">Đổi mật khẩu</a></button>
</b></h3>
</div>
