...
if ($conn->connect_error) {
    ...
    $sql = "SELECT * FROM student join major on student.major_id=major.id";
...
<table border=1><tr><th>ID</th><th>Hoten</th><th>email</th><th>ngaysinh</th><th>Mã CN</th><th>Chuyen nganh</th>
    <th colspan="2">Hanh dong</th></tr>
<?php
